...
# ---------------------------------------------------------------------------
# Leave Service Delegation (Backward-Compatible Re-exports)
# ---------------------------------------------------------------------------
from app.services.leave_service import LeaveService

_get_leave_or_404 = LeaveService.get_leave_or_404
_enrich_leave = LeaveService.enrich_leave
_enrich_leaves_batch = LeaveService.enrich_leaves_batch
