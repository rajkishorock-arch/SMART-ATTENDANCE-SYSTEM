...
export const translations = {
  en: {
    ...
    searching_face: 'Position Face in Center',
    face_locked: 'Hold Still',
    verifying_liveness: 'Blink to Confirm',
    liveness_confirmed: 'Liveness Confirmed',
    matching_face: 'Matching facial signature...',
    attendance_recorded: 'Attendance Recorded',
    already_marked: 'Attendance already recorded for this class today.',
    geofence_out_of_bounds: 'You are outside the campus attendance area.',
    face_not_recognized: 'Face Not Recognized • Try Again',
    offline_queued: "Attendance saved on this device and will sync when you're online.",
    fallback_options: 'Having trouble? Use Manual Entry or QR Code',
    match_confidence: 'Match Confidence',

    // Offline & Sync
    synced_to_cloud: 'Synced to Cloud',
    saved_on_device: "Attendance saved on this device and will sync when you're online.",
    sync_now: 'Sync Now',
  ...
  hi: {
    ...
    face_locked: 'स्थिर रहें',
    verifying_liveness: 'पुष्टि के लिए पलकें झपकाएं',
    liveness_confirmed: 'जीवंतता की पुष्टि हुई',
    matching_face: 'बायोमेट्रिक मिलान हो रहा है...',
    attendance_recorded: 'उपस्थिति दर्ज हो गई',
    already_marked: 'आज इस विषय के लिए उपस्थिति पहले ही दर्ज की जा चुकी है।',
    geofence_out_of_bounds: 'आप कैंपस उपस्थिति क्षेत्र से बाहर हैं।',
    face_not_recognized: 'चेहरा नहीं पहचाना गया • पुनः प्रयास करें',
    offline_queued: 'उपस्थिति इस डिवाइस पर सहेजी गई है और ऑनलाइन होने पर सिंक होगी।',
    ...
    saved_on_device: 'उपस्थिति इस डिवाइस पर सहेजी गई है और ऑनलाइन होने पर सिंक होगी।',
